...
public class DataInitializer {
    ...
    private PermissionDefinition[] definitions() {
        return new PermissionDefinition[]{
                ...
                p("ESOP_READ","ESOP查看","View ESOP","عرض تعليمات العمل","API","ENGINEERING",41),
                p("ESOP_WRITE","ESOP编制","Edit ESOP","تحرير تعليمات العمل","ACTION","ENGINEERING",42),
                p("ESOP_PUBLISH","ESOP发布","Publish ESOP","نشر تعليمات العمل","ACTION","ENGINEERING",43),
                ...
                p("EXECUTION_READ","生产执行查看","View production execution","عرض تنفيذ الإنتاج","API","PRODUCTION",62),
                p("EXECUTION_WRITE","生产执行录入","Create production transactions","إنشاء معاملات الإنتاج","API","PRODUCTION",64),
                p("EXECUTION_POST","生产过账","Post production transactions","ترحيل معاملات الإنتاج","ACTION","PRODUCTION",66),
                ...
                p("PAGE_ESOP","访问ESOP","Access ESOP","الوصول إلى تعليمات العمل","PAGE","ENGINEERING",155),
                ...
                p("PAGE_EXECUTION","访问生产作业","Access production operations","الوصول إلى عمليات الإنتاج","PAGE","PRODUCTION",175),
